        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(i <= 300)) return [3 /*break*/, 4];
                    return [4 /*yield*/, fetch("https://api.themoviedb.org/3/movie/".concat(i, "?language=en-US"), options)
                            .then(function (response) { return response.json(); })
                            .then(function (response) { return promises = response; })
                            .then(function (response) { return movie_1.default.insertMany(response); })
